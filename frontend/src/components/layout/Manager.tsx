...
const Manager = ({
  ...
  return selContact == "" ? (
    <div className="max-w-[725px] w-full h-screen py-4 pr-4 ">
      <div className="bg-gradient-to-b from-blue-600 to-[#FAFAFA] dark:from-blue-950 dark:to-[#121212] rounded-xl h-[calc(100vh-65px)] flex justify-center items-center">
        <div className="text-2xl ubuntu-regular text-[#333333] dark:text-[#e3e3e3] ">
    ...
    <div className="max-w-[725px] w-full h-screen py-4 pr-4">
      <div className=" bg-gradient-to-b rounded-tr-xl rounded-t-xl from-blue-600/85 to-[#FAFAFA] dark:from-blue-950  dark:to-[#121212]">
        ...
        <div className="h-[220px] pr-4 pl-10 flex justify-center gap-4 ">
          ...
          <div className="w-[220px]">
            ...
            <div className="flex gap-2">
              <div className=" flex justify-center items-center w-[35px] h-[35px] dark:bg-[#333333] bg-[#FAFAFA] rounded-lg ">
            ...
            <div>
              <div className="mt-4 flex gap-1">
                <DropdownMenu>
                  <DropdownMenuTrigger className={` flex items-center gap-2`}>
                    <FaPlus
                      className={`text-2xl rounded-full dark:bg-[#333333] bg-[#FAFAFA] p-1.5 `}
                    />
                  </DropdownMenuTrigger>
                ...
                <div className="flex gap-1 ">
                  {contactDetails?.tags?.map((tag, index) => (
                    <div
                      key={index}
                      className="dark:bg-[#333333] bg-[#FAFAFA] rounded-full px-2 text-sm items-center flex dark:text-[#e3e3e3] text-[#121212] "
                    >
                      {tag}
                    </div>
                  ))}
              ...
              <div className="dark:text-[#e3e3e3] text-[#121212] text-sm mt-1">
      ...
      <div className="px-5 py-7 dark:bg-[#333333]/40 bg-[#e3e3e3] rounded-2xl h-[calc(100vh-310px)] ">
        ...
        <div className="max-w-[669px] h-[60px] dark:bg-[#121212] bg-[#FAFAFA] rounded-xl py-3 px-6 flex items-center gap-2 ubuntu-regular">
