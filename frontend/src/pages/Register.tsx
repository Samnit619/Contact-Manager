        ...
        <div className="flex flex-row justify-between bg-[#18181a] w-full h-screen">
          <div className="w-[50%] h-screen  hidden sm:block">
            <img
              ...
              alt="no img"
            />
            <div className="text-4xl m-12 font-sfBold ubuntu-medium text-neutral-100 inline-block p-1 bg-clip-text absolute top-0 left-0">
              ContactHub
            </div>
          </div>
            ...
            <div className="flex flex-col items-center justify-center">
              <form onSubmit={handleSubmit}>
                <div className="flex flex-col items-center justify-center py-8 px-12 rounded-lg">
                  <div className="text-slate-100 text-4xl ubuntu-regular">
                    Create an account
                  </div>
